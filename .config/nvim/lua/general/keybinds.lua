Keybind.g({
    ...
    {'n', '<Leader><CR>', ':luafile $MYVIMRC<CR>'}, -- Navigation
    ...
    {'v', '<Leader>p', '"_dP', {noremap = true}}, -- yank it to global register
    ...
    {'n', '<Leader>Y', 'gg"+yG', {noremap = true}}, -- resize window
