...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-spectre', 'playground', 'nvim-comment', 'gitlinker.nvim', 'nvim-bqf', 'gitsigns.nvim', 'diffview.nvim', 'vim-gist', 'hop.nvim', 'numb.nvim', 'octo.nvim', 'dial.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'nvim-toggleterm.lua', 'dashboard-nvim', 'barbar.nvim', 'which-key.nvim', 'telescope-project.nvim', 'galaxyline.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'nvim-lspinstall'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-compe', 'nvim-ts-autotag', 'vim-vsnip', 'lsp_signature.nvim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
