...
_G.packer_plugins = {
  ...
  ["nvim-ts-context-commentstring"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/dawei/.local/share/lunarvim/site/pack/packer/opt/nvim-ts-context-commentstring",
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'playground', 'numb.nvim', 'nvim-bqf', 'octo.nvim', 'diffview.nvim', 'gitlinker.nvim', 'gitsigns.nvim', 'hop.nvim', 'nvim-spectre', 'dial.nvim', 'Comment.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
