...
_G.packer_plugins = {
  ...
  ["cinnamon.nvim"] = {
    config = { "\27LJ\2\nà\1\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\1K\0\1\0\1\0\5\20default_keymaps\2\17scroll_limit\3d\rcentered\2\21extended_keymaps\1\18extra_keymaps\2\nsetup\rcinnamon\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["lsp_lines.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/dawei/.local/share/nvim/site/pack/packer/opt/lsp_lines.nvim",
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'dressing.nvim', 'which-key.nvim', 'bufferline.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'todo-comments.nvim', 'editorconfig-vim', 'gitsigns.nvim', 'Comment.nvim', 'lsp_signature.nvim', 'cinnamon.nvim', 'nvim-bqf', 'neoscroll.nvim', 'refactoring.nvim', 'lsp_lines.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
