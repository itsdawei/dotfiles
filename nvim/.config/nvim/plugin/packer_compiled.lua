...
_G.packer_plugins = {
  ...
  ["cinnamon.nvim"] = {
    config = { "\27LJ\2\nà\1\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\1K\0\1\0\1\0\5\21extended_keymaps\1\18extra_keymaps\2\20default_keymaps\2\17scroll_limit\3d\rcentered\2\nsetup\rcinnamon\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'Comment.nvim', 'cinnamon.nvim', 'gitsigns.nvim', 'refactoring.nvim', 'lsp_signature.nvim', 'todo-comments.nvim', 'neoscroll.nvim', 'editorconfig-vim', 'nvim-bqf'}, { event = "BufRead *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'dressing.nvim', 'remember.nvim', 'bufferline.nvim', 'which-key.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
