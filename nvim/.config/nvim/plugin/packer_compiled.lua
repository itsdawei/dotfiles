...
_G.packer_plugins = {
  ...
  ["cinnamon.nvim"] = {
    config = { "\27LJ\2\nà\1\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\1K\0\1\0\1\0\5\rcentered\2\21extended_keymaps\1\18extra_keymaps\2\20default_keymaps\2\17scroll_limit\3d\nsetup\rcinnamon\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["vim-table-mode"] = {
    config = { "\27LJ\2\nà\1\0\0\3\0\3\0\0056\0\0\0009\0\1\0'\2\2\0B\0\2\1K\0\1\0i          let g:table_mode_corner_corner='+'\n          let g:table_mode_header_fillchar='='\n        \bcmd\bvim\0" },
    loaded = true,
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'which-key.nvim', 'dressing.nvim', 'remember.nvim', 'bufferline.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'Comment.nvim', 'neoscroll.nvim', 'cinnamon.nvim', 'todo-comments.nvim', 'nvim-bqf', 'gitsigns.nvim', 'refactoring.nvim', 'editorconfig-vim', 'lsp_signature.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
